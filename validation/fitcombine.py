    ...
    for d in dc:
        ...
        for f in fc:
            ...
            for fit in fits.keys():
                ...
                execute(comblog, 'combine -M MultiDimFit '+fits[fit]+'-d higgsCombineBestFit.MultiDimFit.mH120.root --saveNLL -w w --snapshotName \"MultiDimFit\" -n Scan '+opts+' --algo grid --rMin 0.5 --rMax 1.5 --points 5 --freezeParameters r --setParameters r=1 --alignEdges 1')
